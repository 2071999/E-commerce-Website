        ...
        <div className="ecom-contenthny py-5">
          <div className="container py-lg-5">
                  ...
                  <div className="resp-tabs-container hor_1">
                    ...
                    <div>
                      <form
                        action="#"
                        method="post"
                        className="creditly-card-form agileinfo_form information-wrapper"
                      >
                        <section className="creditly-wrapper wthree, w3_agileits_wrapper">
                          <div className="credit-card-wrapper">
                            ...
                            <button className="submit btn btn-style btn-primary mt-4">
                              Make a payment
                            </button>
                          </div>
                        </section>
                      ...
                      >
                        <div className="row">
                          <div className="col-md-6">
                            ...
                            <a className="btn btn-style btn-primary mt-4">
                              Checkout via Paypal
                            </a>
                          </div>
                          <div className="col-md-6">
                              ...
                              <div className="checkbox">
                                <div className="check_box_one pament-check vertical_post">
                                  <label className="anim">
                                    <input
                                      type="checkbox"
                                      className="checkbox checkboxpay"
                                    />
                                    <span className="pe-2">
                                      {" "}
                                      Add to My Cards
            ...
            <div style={{ textAlign: "right", marginTop: "15px" }}>
              <button
                className="submit check_out btn btn-style btn-primary"
                onClick={() => {
                  ProceesToPayment();
                }}
              >
