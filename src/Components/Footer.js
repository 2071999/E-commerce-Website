                    ...
                    <div className="row footer-top-29 mt-md-5">
                        ...
                        <div className="col-lg-3 col-md-6 footer-list-29 footer-4 mt-lg-0 mt-md-5 mt-4  ps-lg-5">
                            ...
                            <ul className="pay-method-grids">
                                <li><a className="pay-method" href="#"><span className="fab fa-cc-visa" aria-hidden="true"></span></a>
                                </li>
                                <li><a className="pay-method" href="#"><span className="fab fa-cc-discover" aria-hidden="true"></span></a>
                                </li>
                                <li><a className="pay-method" href="#"><span className="fab fa-cc-paypal" aria-hidden="true"></span></a>
                                </li>
                                <li><a className="pay-method" href="#"><span className="fab fa-cc-mastercard" aria-hidden="true"></span></a>
                                </li>
                                <li><a className="pay-method" href="#"><span className="fab fa-cc-stripe" aria-hidden="true"></span></a>
                                </li>
                                <li><a className="pay-method" href="#"><span className="fab fa-cc-amex" aria-hidden="true"></span></a>
                                </li>
                                <li><a className="pay-method" href="#"><span className="fab fa-cc-jcb" aria-hidden="true"></span></a>
                                </li>
                                <li><a className="pay-method" href="#"><span className="cc-diners-club" aria-hidden="true"></span></a>
                                </li>
                        ...
                        <div className="row bottom-copies">
                            <p className="copy-footer-29 col-lg-8">© 2023 Goodie Craft. All rights reserved</p>
